...
const BlogItem: React.FC<Props> = ({ featuredBlog }) => {
  return (
    <Link href={`/blog/${featuredBlog.id}`}>
      <a className="p-b-63 d-block">
        <span className="hov-img0 how-pos5-parent">
          <img src={featuredBlog.img} alt="IMG-BLOG" />
        </span>

        <div className="p-t-32">
          <h4 className="p-b-15">
            <span className="ltext-108 cl2 hov-cl1 trans-04">{featuredBlog.title}</span>
          </h4>

          <p className="stext-117 cl6">{featuredBlog.excerpt}</p>

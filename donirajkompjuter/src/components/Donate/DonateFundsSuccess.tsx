...
const DonateFundsSuccess = ({ updateStep }: Props) => {
  ...
  return (
    <div className='container'>
      ...
      <div className="row mt-5">
        <div className="col ">
          <img className='w-100' src="../../images/donateFunds/donateFundsHero.svg" alt="donateFundsHero" />
        </div>
...
export default DonateFundsSuccess